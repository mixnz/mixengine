...
| [10 — Client surface](phase-10-client-surface.md) | What `client-surface.md` claims about itself is true | T96–T97, T182 | 2 / 3 | **M10** MixDB's Dashboard and Settings draw whole, with no business logic in the client — **met** |
