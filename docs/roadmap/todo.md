...
| [24 — A test job that scales](phase-24-a-test-job-that-scales.md) | A branch run is waited for 15 minutes or less; a new suite adds a parallel leg, not serial minutes | T170a–T170l | 3 / 12 | **M24** in a warm branch run every leg finishes in 15 minutes or less, `build` in 20, and none passes 30 |
