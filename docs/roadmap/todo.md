...
| [25 — A workflow a person can read](phase-25-a-workflow-a-person-can-read.md) | A person reads the CI job they change without the other thirteen | T172a–T172e | 2 / 5 | **M25** no workflow file passes 500 lines and a full run matches the one before in jobs, test counts and artifacts |
