...
| plan v1 `2026-09-04-clickhouse-db-kind.md` (local, never committed) | D7 (whitelist decodable), D13 (paging), Phi mục tiêu gốc — nguồn của mọi giới hạn spec này thừa hưởng |
