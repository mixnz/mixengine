...
[frontend.md](../architecture/desktop/frontend.md) cho `core/` import `components/` và `i18n/`
...
[quy ước icon](../standards/desktop/icons.md): nét vẽ trên lưới 24×24, export theo thứ tự chữ
cái trong `index.ts`.
...
[quy ước changelog](../standards/desktop/changelog.md):
