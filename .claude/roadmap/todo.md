...
| [20 — MixLab redesigned](phase-20-mixlab-redesigned.md) | Every screen drawn from one token set, in two themes, at the density its content needs | T157–T163 | 3 / 7 | **M20** every screen renders in both themes with no colour literal outside `App.css`, and the connection editor and Dashboard match their artboards |
