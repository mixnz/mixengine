...
| [19 — MongoDB](phase-19-mongodb.md) | The published MongoDB releases install and run as a service, what they ask of the processor is judged, and MixLab opens one | T153–T156 | 3 / 4 | **M19** `mix service create mongodb@main 8.3.11` keeps a document across a restart, and MixLab's Open lands in a Mongo tab connected to it |
