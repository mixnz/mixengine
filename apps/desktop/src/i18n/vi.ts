...
const vi: SharedDict = {
  ...
  app: {
    settings: "Cài đặt",
    settingsDownloading: "Cài đặt (đang tải thay đổi về)",
    settingsUploading: "Cài đặt (đang gửi thay đổi lên)",
  ...
  update: {
    ...
    checkedAt: "Kiểm tra lần cuối lúc {{time}}.",
    neverChecked: "Chưa kiểm tra lần nào.",
    checkNow: "Kiểm tra ngay",
    checking: "Đang kiểm tra",
    checkFailed: "Không kiểm tra được bản mới. {{message}}",
    automatic: "Tự kiểm tra bản mới",
    automaticHint: "MixLab kiểm tra một lần khi mở và một lần mỗi ngày. Nó không cài gì cho tới khi bạn bấm Cài đặt.",
    upToDate: "Bạn đang dùng bản mới nhất.",
    offered: "Đã có MixLab {{version}}",
    size: "Cần tải {{size}} MB.",
    notesLink: "Xem có gì mới",
    daemonRestarts: "Nếu MixEngine đang chạy, nó sẽ dừng để cập nhật rồi chạy lại cùng các dịch vụ cũ.",
    install: "Cài đặt",
    openInstaller: "Tải bộ cài",
    later: "Để sau",
    skip: "Bỏ qua bản này",
    ...
    installerReady: "Đã cài bản {{version}}. Bấm Hoàn tất để mở lại MixLab trên bản này.",
    installerReopen: "Mở lại",
    installerBack: "Quay lại",
    noBuild: "Bản {{version}} chưa có bản cho máy này.",
    development: "Đây là bản build để phát triển nên không tự cập nhật.",
