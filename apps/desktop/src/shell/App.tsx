...
/* Here rather than in `Workspace`, which is where they were until T108: the first-run screen is
   drawn *instead of* the workspace and wants the same tokens, the same ground and the same theme.
