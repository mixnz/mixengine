...
const terminalEn = {
  terminal: {
    ...
    saveTarget: "Save",
    updateTarget: "Update",
    changedElsewhere: "This saved entry was changed somewhere else. Your edits here stay until you load the new version.",
    loadNewVersion: "Load new version",
    removedElsewhere: "This saved entry was deleted somewhere else. Save keeps it as a new one.",
