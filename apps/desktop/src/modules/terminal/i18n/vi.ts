...
const terminalVi: TerminalDict = {
  terminal: {
    ...
    changedElsewhere: "Mục này vừa được sửa ở nơi khác. Phần bạn đang sửa ở đây vẫn giữ nguyên cho tới khi bạn tải bản mới.",
    loadNewVersion: "Tải bản mới",
    removedElsewhere: "Mục này đã bị xoá ở nơi khác. Bấm Lưu để giữ nó thành một mục mới.",
