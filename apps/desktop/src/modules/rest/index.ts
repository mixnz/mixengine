...
import { environmentSecretsSyncable, environmentsSyncable, requestsSyncable } from "./sync";
...
export const restModule: ModuleDefinition = {
  ...
  syncable: [requestsSyncable, environmentsSyncable, environmentSecretsSyncable],
};
