 ...
 * the local plan `2026-09-04-clickhouse-db-kind.md`, never committed. The Data tab's grid can now write rows
 ...
 * `docs/specs/2026-09-04-clickhouse-ddl-design.md` and
 * `docs/specs/2026-09-04-clickhouse-dump-restore-design.md` — only Query-tab DDL
...
export const clickhouseDialect: SqlDialect = {
  ...
  // `docs/specs/2026-09-04-clickhouse-query-dml-design.md`.
  writable: false,
  // Dump/restore is open — see `docs/specs/2026-09-04-clickhouse-dump-restore-design.md`.
